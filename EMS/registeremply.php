    ...
    <section class="container py-1">
        <div class="row justify-content-center py-3">
            <div class="col-12 col-md-6 py-2">
                <form class="card p-4" method="POST" action="register_data_employee.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" required class="form-control" id="pwd" name="pwd">
                    </div>
                    <!-- pasword input ends -->
                    ...
                    <button type="submit" class="btn btn-primary" name="sbmt">Registered</button>
                </form>
            </div>
        </div>
    </section>
